let questions = [
    ...
    },
    {
        ...
        options: [
            ...
            'Para provar que qualquer defeito remanescente não causará nenhuma fãlhã'
        ],
        answer: 2
    },
    {
    ...
    },
    {
        ...
        options: [
            ...
            'O objetivo do teste de regressão é detectãr efeitos colaterais não intencionais, enquãnto o objetivo do teste de confirmção é verificãr se o defeito original foi corrigido',
    ...
    },
    {
        ...
        options: [
            'Definição de requisitos, projeto de software e testes são feitos em fases em que em cada uma parte do sistema e adicionada',
    ...
    {
        question: 'Qual dos tipos de revisão abaixo é a MELHOR opção para escolher quando a revisão deve seguir um processo formal baseãdo em regras e listas de verificação?',
        options: [
            'Revisão Informal',
            'Revisão Técnica',
            'Inspeção',
